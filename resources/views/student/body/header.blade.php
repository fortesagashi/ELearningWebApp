<header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <img src="assets/img/favicon.png" alt=""> <span class="d-none d-lg-block">"Xheladin Deda"</span> </a> <i class="bi bi-list toggle-sidebar-btn"></i></div>
        @php
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-2" href="#">
                <img src="{{ (!empty($studentData->photo))? url('upload/studen_images/'.$studenData->photo):url('upload/no_image.png')}}" alt="Profile" class="rounded-circle"> <span class="d-none d-md-block ps-2">{{$studentData->name}}</span> </a>
