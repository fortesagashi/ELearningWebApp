...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Shto një libër </h4>

            <form method="post" action="{{ route('store.books') }}" enctype="multipart/form-data">
                @csrf
</br>
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Shto librin">
            </form>
